...
public class IPv4 extends ProtocolSpec {
    ...
    public int totalLength () {
        return BinaryUtils.extractInt(frame, pduTailOrigin+2, 16, 16);
    }

    public int identification () {
        return BinaryUtils.extractInt(frame, pduTailOrigin+4, 0, 16);
    }

    public int flags () {
        return BinaryUtils.extractInt(frame, pduTailOrigin+6, 0, 3);
    }

    public int fragmentOffset () {
        return BinaryUtils.extractInt(frame, pduTailOrigin+6, 3, 13);
    }

    public int ttl () {
        return BinaryUtils.extractInt(frame, pduTailOrigin, , );
    }
}
